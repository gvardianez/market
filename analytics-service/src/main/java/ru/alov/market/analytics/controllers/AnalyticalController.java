...
public class AnalyticalController {
    ...
    public Flux<ProductRatingDto>  getProductQuantityRatingForPeriod(@RequestBody RequestRatingDto requestRatingDto) {
        return analyticalService.getProductQuantityRatingPeriod(requestRatingDto);
    }

    @PostMapping("/product-quantity-cost-rating-period")
    public Flux<ProductRatingDto> getProductQuantityAndCostRatingForPeriod(@RequestBody RequestRatingDto requestRatingDto) {
