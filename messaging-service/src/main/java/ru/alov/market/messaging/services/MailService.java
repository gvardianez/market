...
public class MailService {
    ...
    public void sendRecoverPasswordMail(@Valid RecoverPasswordRequestDto recoverPasswordRequestDto) throws MessagingException {
        sendMail(recoverPasswordRequestDto.getEmail(), "Пароль успешно изменен", "Новый пароль: " + recoverPasswordRequestDto.getPassword());
    }
