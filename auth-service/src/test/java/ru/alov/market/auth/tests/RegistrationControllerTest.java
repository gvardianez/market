...
public class RegistrationControllerTest {
    ...
    public void createNewUserTest() throws Exception {
        ...
        System.out.println(objectMapper.writeValueAsString(longListDto));

        String validJsonRequest = objectMapper.writeValueAsString(new RegisterUserDto("vasya", "234DF#asdfr3", "234DF#asdfr3", "tasdu@ya.ru"));
    ...
    public void confirmEmailTest() throws Exception {
        ...
        mvc.perform(
           ...
           .andExpect(jsonPath("$.message", is("Email пользователя не совпадает с указанным при регистрации")));
