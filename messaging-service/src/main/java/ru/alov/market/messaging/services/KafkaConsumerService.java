...
public class KafkaConsumerService {
    ...
    public void listenerRecoverPassword(@Valid RecoverPasswordRequestDto recoverPasswordRequestDto) throws MessagingException {
    ...
    public void listenerPromotion(@Valid PromotionDto promotionDto) throws MessagingException, TelegramApiException {
