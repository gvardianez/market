...
public class AccountController {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            description = "Введеные пароли не совпадают", responseCode = "404",
                            content = @Content(schema = @Schema(implementation = AuthServiceAppError.class))
                    ),
                    @ApiResponse(
                            description = "Неверно указан старый пароль", responseCode = "404",
                            content = @Content(schema = @Schema(implementation = AuthServiceAppError.class))
                    )
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            description = "Для восстановления пароля необходимо подтвредить Email", responseCode = "404",
                            content = @Content(schema = @Schema(implementation = AuthServiceAppError.class))
                    )
            }
    )
