...
public class AnalyticsIntegrationTest {
    ...
    @Test
    public void AnalyticsControllerGetProductQuantityRatingForPeriodTest() throws JsonProcessingException {

        RequestRatingDto requestRatingDto = new RequestRatingDto(null, localDateTimeStartFirstTest, localDateTimeEnd, null);

        String ratingDtoFlux = restTemplate.postForObject("/api/v1/analytical/product-quantity-rating-period", requestRatingDto, String.class);
    ...
    @Test
    public void AnalyticsControllerGetProductQuantityAndCostRatingForPeriodTest() throws JsonProcessingException {

        RequestRatingDto requestRatingDto = new RequestRatingDto(null, localDateTimeStartOtherTests, localDateTimeEnd, null);
    ...
    @Test
    public void AnalyticsControllerGetProductQuantityAndCostRatingForPeriodWithCountTest() throws JsonProcessingException {

        RequestRatingDto requestRatingDto = new RequestRatingDto(null, localDateTimeStartOtherTests, localDateTimeEnd, 2L);
    ...
    public void AnalyticsControllerUserProductsRatingForPeriodTest() {
        ...
        Assertions.assertEquals(BigDecimal.valueOf(200.35), userProductsRatingDto.getProductRatingDtoList().get(0).getCost());
        Assertions.assertEquals(1, userProductsRatingDto.getProductRatingDtoList().get(1).getQuantity());
        Assertions.assertEquals("Сыр", userProductsRatingDto.getProductRatingDtoList().get(2).getProductDto().getTitle());
