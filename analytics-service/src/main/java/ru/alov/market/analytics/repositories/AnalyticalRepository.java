...
public interface AnalyticalRepository extends JpaRepository<Analytical, Long> {
    ...
    @Query(nativeQuery = true, value =
            "SELECT \n" +
                    ...
                    "LIMIT :count")
    List<AnalyticalProductsQuantityRating> findProductQuantityRatingWithCount(@Param("localDateTimeStart") LocalDateTime localDateTimeStart, @Param("localDateTimeEnd") LocalDateTime localDateTimeEnd, @Param("count") Long count);
    ...
    @Query(nativeQuery = true, value =
            "SELECT \n" +
                    ...
                    "WHERE bought_at BETWEEN :localDateTimeStart AND :localDateTimeEnd\n" +
                    "GROUP BY product_id ")
    List<AnalyticalProductsQuantityAndCostRating> findProductQuantityAndCostRating(@Param("localDateTimeStart") LocalDateTime localDateTimeStart, @Param("localDateTimeEnd") LocalDateTime localDateTimeEnd);
    ...
    @Query(nativeQuery = true, value =
            "SELECT \n" +
                    ...
                    "ORDER BY quantity DESC\n" +
                    "LIMIT :count")
    List<AnalyticalProductsQuantityAndCostRating> findProductQuantityAndCostRatingWithCount(@Param("localDateTimeStart") LocalDateTime localDateTimeStart, @Param("localDateTimeEnd") LocalDateTime localDateTimeEnd, @Param("count") Long count);
    ...
    List<AnalyticalUserProductsStatistic> findUserProductStatistic(@Param("username") String username, @Param("localDateTimeStart") LocalDateTime localDateTimeStart, @Param("localDateTimeEnd") LocalDateTime localDateTimeEnd);
