...
public class ReviewController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            description = "Отзыв успешно создан", responseCode = "201"
                    ),
                    @ApiResponse(
                    ...
                    @ApiResponse(
                            description = "Вы не приобретали у нас данный товар", responseCode = "400",
                            content = @Content(schema = @Schema(implementation = CoreServiceAppError.class))
                    ),
                    @ApiResponse(
                            description = "Вы уже оставили отзыв да данный товар", responseCode = "400",
                            content = @Content(schema = @Schema(implementation = CoreServiceAppError.class))
                    )
            }
    )
