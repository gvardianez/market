...
public class CartServiceTests {
    ...
    public void setProductQuantityTest() {
        Assertions.assertThrows(ResourceNotFoundException.class, () -> cartService.setProductQuantity(cartId, cheeseDto.block().getId(), -5));

        Mockito.doReturn(cheeseDto)
               .when(coreServiceIntegration)
               .findById(cheeseDto.block().getId());
