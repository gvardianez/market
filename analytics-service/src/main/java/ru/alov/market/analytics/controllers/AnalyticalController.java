...
public class AnalyticalController {
  ...
  @Operation(
      summary =
          "Запрос на получение аналитики по количеству проданных товаров за определенный период "
              + "с возможностью вывода конкретного количества пунктов",
      responses = {
        @ApiResponse(
            description = "Успешный ответ",
            responseCode = "200",
  ...
  @Operation(
      summary =
          "Запрос на получение аналитики по количеству проданных товаров и их общей "
              + "стоимости(по каждой сумме по позиции товара) за определенный период с возможность вывода "
              + "конкретного количества пунктов",
      responses = {
        @ApiResponse(
            description = "Успешный ответ",
            responseCode = "200",
  ...
  @Operation(
      summary =
          "Запрос на получение аналитики для опреденного пользователя по количеству проданных товаров"
              + " и их стоимости за указанный период",
      responses = {
        @ApiResponse(
            description = "Успешный ответ",
            responseCode = "200",
